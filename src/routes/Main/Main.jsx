...
export const Main = () => {
  ...
  const cardData2 = [
    { title: `${t("cardData2Title1")}`, subtitle: `${t("cardData2Subtitle1")}` },
    { title: `${t("cardData2Title2")}`, subtitle: `${t("cardData2Subtitle2")}` },
    { title: `${t("cardData2Title3")}`, subtitle: `${t("cardData2Subtitle3")}` },
    { title: `${t("cardData2Title4")}`, subtitle: `${t("cardData2Subtitle4")}` },
    { title: `${t("cardData2Title5")}`, subtitle: `${t("cardData2Subtitle5")}` },
    { title: `${t("cardData2Title6")}`, subtitle: `${t("cardData2Subtitle6")}` },
    { title: `${t("cardData2Title7")}`, subtitle: `${t("cardData2Subtitle7")}` },
    { title: `${t("cardData2Title8")}`, subtitle: `${t("cardData2Subtitle8")}` },
  ];
